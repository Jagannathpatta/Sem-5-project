    ...
    public partial class test : System.Web.UI.Page
    {
        ...
        void populateGridView()
        {
            ...
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                sqlda.SelectCommand.Parameters.AddWithValue("@deptID", 120);
                sqlda.SelectCommand.Parameters.AddWithValue("@collegeCode", 101);
                sqlda.Fill(dtd1);
            }
            ...
            try
            {
                if (e.CommandName.Equals("AddNew"))
                {
                    using (SqlConnection conn = new SqlConnection(connectionString))
                    {
                        ...
                        cmd.Parameters.AddWithValue("@collegeCode", 101 /*Convert.ToInt32((GridView1.FooterRow.FindControl("collegeCodeTextBoxfooter") as TextBox).Text.Trim())*/);
                        cmd.Parameters.AddWithValue("@deptID", 120 /*Convert.ToInt32((GridView1.FooterRow.FindControl("deptIDTextBoxfooter") as TextBox).Text.Trim())*/);
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            try
            {
                using (SqlConnection conn = new SqlConnection(connectionString))
                {
                    ...
                    cmd.Parameters.AddWithValue("@collegeCode", 101 /*Convert.ToInt32((GridView1.Rows[e.RowIndex].FindControl("collegeCodeTextBox") as TextBox).Text.Trim())*/);
                    cmd.Parameters.AddWithValue("@deptID", 120 /*Convert.ToInt32((GridView1.Rows[e.RowIndex].FindControl("deptIDTextBox") as TextBox).Text.Trim())*/);
